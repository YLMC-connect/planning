...
const APP_SECTIONS = [
  ...
  },
  {
    ...
    boards: [
      ...
      b('study-detail-applied-modal', '32-2 · 삶공부 과정 상세 — 이미 신청 모달 (FUNC-064)', ScreenStudyDetail, { variant: 'applied-modal' }),
      b('study-detail-blocked-modal', '32-3 · 삶공부 과정 상세 — 신청 불가 모달 (FUNC-061)', ScreenStudyDetail, { variant: 'blocked-modal' }),
      ...
      b('study-history', '34 · 삶공부 수강 내역 (FUNC-064)', ScreenStudyHistory),
      b('study-admin', '35 · 내 담당 삶공부 관리 (FUNC-059)', ScreenStudyAdminCourses),
...
const PREVIEW_TEXT_ROUTES = [
  ...
  ['home', '삶공부 진행', 'study-detail-enrolled'],
  ...
  ['study-list', '커플의 삶', 'study-detail'],
  ['study-list', '교사의 삶', 'study-detail'],
  ['study-list', '목자목녀의 삶', 'study-detail'],
  ['study-list', '부모의 삶', 'study-detail'],
  ['study-list', '일터의 삶', 'study-detail'],
  ['study-list', '큐티의 삶', 'study-detail'],
  ['study-list', '기도의 삶', 'study-detail'],
  ['study-list', '말씀통독의 삶', 'study-detail'],
  ['study-list', '성경암송의 삶', 'study-detail'],
  ['study-list', '정체성 누리는 삶', 'study-detail'],
  ['study-list', '수강 내역 보기', 'study-history'],
  ['study-list', '수강 내역', 'study-history'],
  ['study-list-admin', '내 담당 삶공부', 'study-admin'],
  ['study-detail', '수강 신청', 'study-apply'],
  ['study-detail-enrolled', '수강 내역 보기', 'study-history'],
  ['study-detail-applied-modal', '수강 내역 보기', 'study-history'],
  ['study-apply-complete', '수강 내역 보기', 'study-history'],
  ['study-history', '신청 상태 확인', 'study-detail-applied-modal'],
  ['study-history', '생명의 삶', 'study-detail-enrolled'],
