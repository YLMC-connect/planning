...
const APP_SECTIONS = [
  ...
  },
  {
    ...
    boards: [
      ...
      b('pray-members-room-select', '27-2-2 · 관리 기도방 선택 (FUNC-052)', ScreenPrayerMembers, { variant: 'room-select' }),
  ...
  },
  {
    ...
    boards: [
      ...
      b('me-prayer-history', '7-4 · 중보기도 활동 이력 (FUNC-057)', ScreenPrayerVolunteerHistory),
