...
const APP_SECTIONS = [
  ...
  },
  {
    ...
    boards: [
      b('pray-list', '25 · 중보기도 메인 (FUNC-040)', ScreenPrayerList),
      ...
      b('pray-moderation', '27-3 · 기도제목 승인·수정·삭제 (FUNC-053)', ScreenPrayerModeration),
      b('pray-urgent-admin', '27-4 · 긴급 기도제목 관리 (FUNC-054)', ScreenPrayerUrgentManage),
      b('pray-offline-match', '27-5 · 오프라인 요청자 회원 매칭 (FUNC-055)', ScreenPrayerOfflineMatch),
